...
import cn.nexura.maker.meta.Meta.FileConfig.FileInfo;
import cn.hutool.core.date.DateUtil;
import cn.hutool.core.util.StrUtil;
import cn.nexura.maker.meta.Meta.FileConfig;
import cn.nexura.maker.meta.enums.FileGenerateTypeEnum;
import cn.nexura.maker.meta.enums.FileTypeEnum;
import cn.nexura.maker.meta.enums.ModelTypeEnum;

/**
 * @author PeiYP
 * @since 2023年12月22日 15:37
 */
public class MetaValidator {
    ...
    public static void validAndFillMetaRoot(Meta meta) {
        ...
        String author = StrUtil.emptyToDefault(meta.getAuthor(), "peiYP");
        String basePackage = StrUtil.blankToDefault(meta.getBasePackage(), "cn.nexura");
