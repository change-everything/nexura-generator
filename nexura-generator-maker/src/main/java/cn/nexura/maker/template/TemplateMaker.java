...
public class TemplateMaker {
    ...
    public static void main(String[] args) {
        ...
        modelInfoConfig1.setDefaultValue("jdbc:mysql://localhost:3306/my_project_db");
        modelInfoConfig1.setReplaceText("jdbc:mysql://localhost:3306/my_project_db");
